                                ...
                                <div className="flex flex-col md:flex-row gap-8 md:gap-14">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {area.cta.href ? (
                                            <Link
                                                href={area.cta.href}
                                                className="group inline-flex items-center gap-2 font-semibold text-sm px-6 py-3 rounded-full transition-all duration-200 hover:scale-[1.02]"
                                                style={{
                                            ...
                                            <Cta text={area.cta.text} size="small" />
                                        )}
                                    </div>
                ...
                <Container>
                    <div className="max-w-lg mx-auto text-center">
                        ...
                        <p className="text-sm md:text-base leading-relaxed mb-8" style={{ color: C.gray2 }}>
                            {renderBold("O primeiro passo é simples: **descreva sua situação**. A análise inicial é gratuita e sigilosa.")}
                        </p>
