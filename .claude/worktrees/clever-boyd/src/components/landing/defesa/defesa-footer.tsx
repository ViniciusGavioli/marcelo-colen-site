            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid md:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        >
                            Advocacia especializada em Direito Antidiscriminatório
                            e defesa de vítimas de racismo e injúria racial.
                        </p>
                        <p
                            className="text-xs mt-4"
                            style={{ color: 'rgba(255,255,255,0.4)' }}
                        >
                            Escritório em Belo Horizonte/MG • Atendimento em todo Brasil
                        </p>
                    </div>
