...
// ============================================================================
// CORES — paleta unificada com LP advogado-cotas-raciais
// ============================================================================
const C = {
    bg1: "#0a0a0a",
    bg2: "#111111",
...
const D = {
    ...
    eliminacao: {
        p1: "Você passou em tudo. Prova, título, documentação. E a banca te eliminou sem explicar o motivo.",
        p2: "Isso acontece mais do que deveria. Só nos últimos 12 meses, analisamos mais de 80 casos de indeferimento em heteroidentificação.",
        p3: "A pergunta que importa: a banca seguiu o procedimento do edital e fundamentou a decisão? Se não fez, existe base técnica para recurso.",
        cta: "Descobrir se a banca errou no meu caso",
    },
    erros: {
    ...
    steps: {
        ...
        items: [
            { n: "01", t: "Você envia agora", d: "Manda o resultado e o edital pelo WhatsApp. Print, PDF ou foto.", Icon: Send },
            { n: "02", t: "Análise em horas", d: "O Dr. Marcelo analisa pessoalmente: motivação da banca, procedimento do edital e prazo. Resposta em até 24h.", Icon: Search },
            { n: "03", t: "Orientação", d: "Você recebe a análise com a viabilidade do recurso e decide como seguir. Sem compromisso.", Icon: Gavel },
        ],
...
// ============================================================================
// CTA BUTTON — dark gold border pill (padrão unificado)
// ============================================================================
...
// ============================================================================
// HERO CTA — botão pill dourado (hero)
// ============================================================================
            ...
            <Container className="relative z-10">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mt-10">
                        <Cta text="Quero o mesmo resultado" />
                    </div>
                </div>
            </Container>
        </section>
            ...
            <section className="relative flex items-center overflow-hidden py-14 md:py-28 lg:py-36" style={{ backgroundColor: C.bg1 }}>
                ...
                <Container className="relative z-10 w-full px-4 md:px-6">
                    <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
                        ...
                        {/* Badge de urgência */}
                        <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 mb-5 md:mb-6 w-fit" style={{ backgroundColor: "rgba(248,113,113,0.08)", border: "1px solid rgba(248,113,113,0.20)" }}>
                            <AlertTriangle className="w-3.5 h-3.5" style={{ color: "#F87171" }} />
                            <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest leading-none" style={{ color: "#FCA5A5" }}>{D.hero.badge}</span>
                        </div>
                ...
                <section className="py-16 md:py-28 relative overflow-hidden" style={{ backgroundColor: C.bg2 }}>
                    ...
                    <Container className="relative z-10">
                        <div className="max-w-2xl mx-auto text-center px-4">
                            ...
                            <GoldDivider />
                            <div className="space-y-5 mt-8 mb-10 text-left md:text-center">
                                <p className="text-base md:text-lg leading-relaxed" style={{ color: C.gray1 }}>
                                    {D.eliminacao.p1}
                                </p>
                                <p className="text-base md:text-lg leading-relaxed" style={{ color: C.gray2 }}>
                                    {D.eliminacao.p2}
                                </p>
                                <p className="text-base md:text-lg leading-relaxed font-medium" style={{ color: C.gray1 }}>
                                    {D.eliminacao.p3}
                                </p>
                            </div>
                            <Cta text={D.eliminacao.cta} />
                        </div>
                    </Container>
                </section>
            </Reveal>
                ...
                >
                    ...
                    <Container className="relative z-10">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <GoldDivider />
                            <p className="text-sm md:text-base text-center mt-3 mb-10" style={{ color: C.gray2 }}>
                                {D.erros.subtitle}
                            </p>
                            <div className="grid md:grid-cols-2 gap-4 mb-10">
                                {D.erros.items.map((item, i) => (
                                    <div
                                        key={i}
                                        className="rounded-2xl p-5 flex gap-4 transition-colors hover:bg-white/[0.03]"
                                        style={{
                                    ...
                                    >
                                        <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 font-bold text-xs" style={{ backgroundColor: C.gold, color: C.bg1 }}>✓</div>
                                        <div>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="text-base md:text-lg leading-relaxed italic mb-5 relative z-10" style={{ color: C.gray1 }}>
                                    A maioria dos recursos contra heteroidentificação falha por falta de fundamentação técnica. Nosso trabalho começa exatamente aí: identificar se a banca cometeu erro de procedimento ou de motivação.
                                </p>
                                <div className="h-px mb-4" style={{ background: `linear-gradient(to right, ${C.gold}, transparent)`, opacity: 0.3 }} />
                ...
                <Container className="relative z-10">
                    <div className="max-w-lg mx-auto text-center">
                        <p className="text-xl md:text-2xl font-bold mb-3" style={{ color: C.white, fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
                            O prazo corre independente da sua decisão.
                        </p>
                        <p className="text-sm md:text-base mb-8" style={{ color: C.gray2 }}>
                            Manda os documentos agora e descobre se tem fundamento.
                        </p>
                        ...
                        >
                            ...
                            <p className="text-sm font-bold italic text-center" style={{ color: C.gray2 }}>
                                &ldquo;Olá doutor, fui indeferido na heteroidentificação. Meu concurso é [nome do concurso] e o prazo do recurso é [data]. Posso enviar o resultado?&rdquo;
                            </p>
                        </div>

                        <Cta text="Enviar meu caso agora" full />
